...
class SimliVideoGenerator(VideoGenerator):
    def __init__(self, avatar_options: AvatarOptions):
        ...
        self._recv_audio_atask: asyncio.Task = asyncio.create_task(self._recv_audio_task())
        self._recv_video_atask: asyncio.Task = asyncio.create_task(self._recv_video_task())
